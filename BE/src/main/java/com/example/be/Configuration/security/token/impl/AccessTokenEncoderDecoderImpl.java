...
import com.example.be.Configuration.security.token.AccessTokenDecoder;
import com.example.be.Configuration.security.token.AccessTokenEncoder;
import com.example.be.Configuration.security.token.exception.InvalidAccessTokenException;
...
public class AccessTokenEncoderDecoderImpl implements AccessTokenEncoder, AccessTokenDecoder {
    ...
    public AccessToken decode(String accessTokenEncoded) {
        try {
            ...
            return new AccessTokenImpl(claims.getSubject(), customerId, roles);
